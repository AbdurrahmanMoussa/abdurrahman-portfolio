const getProjectInfo = [
  {
    ...
    image: "/pizzaapp.png",
    description:
      "A pizza store app that allows users to order pizza and pay for it via cash on delivery or PayPal. Includes Admin panel to manage each specific order and view previous orders as well as ability to add, delete, and update a product.",
  ...
  },
  {
    ...
    link: [
      {
        name: "Code",
        url: "https://github.com/AbdurrahmanMoussa/NHL-Stats-app",
      },
